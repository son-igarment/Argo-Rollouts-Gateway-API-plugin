...
data:
  trafficRouterPlugins: |-
    - name: "phamlengocson/gatewayAPI"
      location: "https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/releases/download/<version>/gatewayapi-plugin-<arch>"
```

You can find the available versions and architectures at the [Releases page](https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/releases).
...
data:
  trafficRouterPlugins: |-
    - name: "phamlengocson/gatewayAPI"
      location: "https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/releases/download/v0.4.0/gatewayapi-plugin-linux-amd64"
```
...
controller:
    initContainers:                                   
      - name: copy-gwapi-plugin
        image: ghcr.io/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi:v0.5.0
        command: ["/bin/sh", "-c"]                    
        args:
...
We publish [container images](https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/pkgs/container/rollouts-plugin-trafficrouter-gatewayapi) for both ARM and x86.
...
```
time="XXX" level=info msg="Downloading plugin phamlengocson/gatewayAPI from: https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/releases/download/v0.4.0/gatewayapi-plugin-linux-amd64"
...
```yaml
  trafficRouterPlugins:
    trafficRouterPlugins: |-
      - name: "phamlengocson/gatewayAPI"
        location: "https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/releases/download/vX.X.X/gatewayapi-plugin-linux-amd64"
        args:
        - "-kubeClientQPS=40"
        - "-kubeClientBurst=80"
```
