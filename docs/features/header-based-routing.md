...
For a complete example with header based routing see our [LinkerD example](https://github.com/phamlengocson/rollouts-plugin-trafficrouter-gatewayapi/tree/main/examples/linkerd-header-based).